...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProject.parse_errors'
        db.add_column(u'main_userproject', 'parse_errors',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProject.parse_errors'
        db.delete_column(u'main_userproject', 'parse_errors')
