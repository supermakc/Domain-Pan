...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'URLMetrics.query_url'
        db.add_column(u'main_urlmetrics', 'query_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


        # Changing field 'URLMetrics.title'
        db.alter_column(u'main_urlmetrics', 'title', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'URLMetrics.query_url'
        db.delete_column(u'main_urlmetrics', 'query_url')


        # Changing field 'URLMetrics.title'
        db.alter_column(u'main_urlmetrics', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
