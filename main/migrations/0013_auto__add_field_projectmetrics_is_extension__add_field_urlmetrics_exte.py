...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectMetrics.is_extension'
        db.add_column(u'main_projectmetrics', 'is_extension',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'URLMetrics.extended_from'
        db.add_column(u'main_urlmetrics', 'extended_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.URLMetrics'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectMetrics.is_extension'
        db.delete_column(u'main_projectmetrics', 'is_extension')

        # Deleting field 'URLMetrics.extended_from'
        db.delete_column(u'main_urlmetrics', 'extended_from_id')
