...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProject.creation_datetime'
        db.add_column(u'main_userproject', 'creation_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'UserProject.completed_datetime'
        db.add_column(u'main_userproject', 'completed_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProject.creation_datetime'
        db.delete_column(u'main_userproject', 'creation_datetime')

        # Deleting field 'UserProject.completed_datetime'
        db.delete_column(u'main_userproject', 'completed_datetime')
