...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MozLastUpdate'
        db.create_table(u'main_mozlastupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('retrieved', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'main', ['MozLastUpdate'])


    def backwards(self, orm):
        # Deleting model 'MozLastUpdate'
        db.delete_table(u'main_mozlastupdate')
