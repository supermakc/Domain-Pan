...
DATABASES = {
    'default': {
        ...
        'NAME': 'domain_checker',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/domainpan/domainpan.co/Domain-Pan/domain_checker/media/'
...
SECRET_KEY = '5ofq(+(_^8zrsa_d&%60^9gy2_=sqitovtal0(7xxg)@a%(swp'
