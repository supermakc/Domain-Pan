...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProject.updated'
        db.delete_column(u'main_userproject', 'updated')

        # Adding field 'UserProject.completion_email_sent'
        db.add_column(u'main_userproject', 'completion_email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProject.last_updated'
        db.add_column(u'main_userproject', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProject.updated'
        db.add_column(u'main_userproject', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None),
                      keep_default=False)

        # Deleting field 'UserProject.completion_email_sent'
        db.delete_column(u'main_userproject', 'completion_email_sent')

        # Deleting field 'UserProject.last_updated'
        db.delete_column(u'main_userproject', 'last_updated')
