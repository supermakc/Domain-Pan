...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectMetrics'
        db.create_table(u'main_projectmetrics', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.UserProject'])),
            ('urlmetrics', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.URLMetrics'])),
            ('is_checked', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'main', ['ProjectMetrics'])
    ...
    def backwards(self, orm):
        # Deleting model 'ProjectMetrics'
        db.delete_table(u'main_projectmetrics')

        # Adding field 'ProjectDomain.url_metrics'
        db.add_column(u'main_projectdomain', 'url_metrics',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.URLMetrics'], null=True, blank=True),
                      keep_default=False)
