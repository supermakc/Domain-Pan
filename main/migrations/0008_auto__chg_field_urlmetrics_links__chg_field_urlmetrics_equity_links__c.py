...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_urlmetrics', 'links', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'URLMetrics.equity_links'
        db.alter_column(u'main_urlmetrics', 'equity_links', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'URLMetrics.external_links'
        db.alter_column(u'main_urlmetrics', 'external_links', self.gf('django.db.models.fields.FloatField')(null=True))
